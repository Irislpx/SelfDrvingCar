...
def load_data():
	...
	for single_npz in training_data:
		with np.load(single_npz) as data:
			...
			train_temp = data['train_imags']
			#print('train_temp.shape = ', np.shape(train_temp))
			train_labels_temp = data['train_labels']
			#print('train_labels_temp.shape = ', np.shape(train_labels_temp))
		label_array = np.vstack((label_array, train_labels_temp))
		#print('image_array.shape = ', np.shape(image_array))
		#print('label_array.shape = ', np.shape(label_array))
